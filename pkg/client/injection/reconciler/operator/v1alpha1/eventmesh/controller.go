...
import (
	...
	client "github.com/creydr/knative-emo-poc/pkg/client/injection/client"
	eventmesh "github.com/creydr/knative-emo-poc/pkg/client/injection/informers/operator/v1alpha1/eventmesh"
	zap "go.uber.org/zap"
...
const (
	defaultControllerAgentName = "eventmesh-controller"
	defaultFinalizerName       = "eventmeshes.operator.knative.dev"
)
...
func NewImpl(ctx context.Context, r Interface, optionsFns ...controller.OptionsFn) *controller.Impl {
	...
	lister := eventmeshInformer.Lister()
	...
	logger = logger.With(
		...
		zap.String(logkey.Kind, "operator.knative.dev.EventMesh"),
	)
